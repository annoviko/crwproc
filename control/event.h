...
std::ostream& operator<<(std::ostream& p_stream, const event_rename& p_event);
std::ostream& operator<<(std::ostream& p_stream, const event_set_multiplier& p_event);
